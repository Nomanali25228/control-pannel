    ...
    <div className="bg-[#111827] min-h-screen">
      ...
      lg:translate-x-0 lg:relative lg:block`}
        ...
        <main className="flex-1 p-4 sm:p-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-3 sm:p-6 mb-6 sm:mb-8">
            {/* Header Section */}
            ...
            <div className="mb-4 sm:mb-6 flex flex-wrap gap-2">
              {filters.map((label, index) => (
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-xs sm:text-sm font-medium transition-all cursor-pointer backdrop-blur-sm ${selected === label
